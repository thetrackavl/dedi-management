...
app.get('/standings', (req, res) => {
    ...
    // console.log(api_url);
    axios.get(api_url, {timeout: 1000})
    .then(resp => {
        // console.log(resp.data);
        res.json(resp.data);
    })
...
app.get('/race/car', (req, res) => {
    let race_selection_port = 5397;
    let driver_api_ip = req.query.ip || pod_ip(req.query.pod_id);
    let race_selection_url = 'http://' + driver_api_ip + ':' + race_selection_port + '/rest/race/car';
    axios.get(race_selection_url, {timeout: 300})
    .then(resp => {
        // console.log(resp.data);
        // console.log('driver state in call is ' + resp.data['state']['navigationState']);
...
app.post('/race/car', (req, res) => {
    ...
    let api_url = 'http://' + driver_api_ip + ':' + driver_api_port + '/race/car/';
    // console.log(api_url);
    request.post({
        url: api_url,
        body: car_id
